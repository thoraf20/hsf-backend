...
export const preQualifySchema = z
  .object({
    ...
    employment_position: z.string().min(1, "Employment position is required").optional(),
    employer_address: z.string().min(1, "Employer address is required").optional(),
    employer_state: z.string().min(1, "Employer state is required").optional(),
    years_to_retirement: z.number().min(0, "Years to retirement must be non-negative").optional(),
